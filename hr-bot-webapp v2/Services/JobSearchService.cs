...
namespace hr_bot_webapp_v2.Services
{
    ...
    {
        private readonly RestClient _client = new("https://jsearch.p.rapidapi.com");

        public async Task<JobSearchResponse> SearchJobs(string position, string location, int page, int num_pages, int radius = 0)
        {
